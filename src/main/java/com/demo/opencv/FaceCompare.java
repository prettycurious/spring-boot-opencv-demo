...
//            ClassLoader.getSystemResource("dlls/opencv_java470.dll");
            ...
            // Mac操作系统
            System.load("/Users/user/Software/OpenCV/opencv/build/lib/libopencv_java490.dylib");
        }

        // 引入 特征分类器配置 文件：haarcascade_frontalface_alt.xml 文件路径
        String property = "/Users/user/Demo/spring-boot-opencv-demo/src/main/resources/xml/haarcascade_frontalface_alt.xml";
        System.out.println(property);
        faceDetector = new CascadeClassifier(property);
    }

    private static final String PATH_PREFIX = "/Users/user/Demo/spring-boot-opencv-demo/src/main/resources/img/";
...
//        face("img.jpg");
        ...
        double compareHist = compare_image(PATH_PREFIX + "1.jpg", PATH_PREFIX + "2.jpg");
